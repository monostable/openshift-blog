...
function init(options) {
    ...
    blogApp.get('/.well-known/acme-challenge/LqbmlbJbH4PAjkRN44ajhuX-gtgHa49LxtZWRBawrEs', function(req, res, next) {
        return res.end('LqbmlbJbH4PAjkRN44ajhuX-gtgHa49LxtZWRBawrEs.wlcJNuGUNkn0bocozZcBxnaPfmr4LiFTkmyn3cGyBp0');
    });
